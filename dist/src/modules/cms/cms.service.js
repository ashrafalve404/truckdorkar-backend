    ...
    async getContent(key) {
        ...
        if (key === 'SYSTEM_SETTINGS') {
            ...
            const meta = content?.metaJson && typeof content.metaJson === 'object'
                ? { ...content.metaJson }
                : {};
            const hasLegacyId = Array.isArray(meta.truckFares) && meta.truckFares.some((f) => f.id.includes('7_9FT') || f.id.includes('16_14FT') || f.id.includes('10_12FT') || f.nameEn?.includes('7/9') || f.nameEn?.includes('14/16'));
