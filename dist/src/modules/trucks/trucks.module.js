...
exports.TrucksModule = TrucksModule = __decorate([
    (0, common_1.Module)({ imports: [storage_module_1.StorageModule], controllers: [trucks_controller_1.TrucksController], providers: [trucks_service_1.TrucksService], exports: [trucks_service_1.TrucksService] })
], TrucksModule);
